    ...
    public class CepService : ICepService
    {
        ...
        public async Task<CepResponse?> BuscarCepAsync(string cep)
        {
            ...
            try
            {
                ...
                if (cepData == null || cepData.Erro == true || string.IsNullOrWhiteSpace(cepData.Cep))
                    return null;
        ...
        // Classe auxiliar para deserializar a resposta da ViaCEP
        private class ViaCepResponse
        {
            ...
            public bool? Erro { get; set; } // ViaCEP retorna {"erro": true} quando CEP não existe
        }
    }
}
